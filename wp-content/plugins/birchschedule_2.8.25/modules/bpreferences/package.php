...
birch_ns( 'birchschedule.bpreferences', function( $ns ) {
		...
		birch_defn( $ns, 'filter_booking_time_options',
		...
		birch_defn( $ns, 'get_cut_off_time', function( $cut_off_time ) use( $ns ) {
		...
		birch_defn( $ns, 'get_future_time', function( $future_time ) use( $ns ) {
				$booking_preferences = $ns->get_booking_preferences();
		...
		birch_defn( $ns, 'get_cut_off_times', function() {
				return array(
		...
		birch_defn( $ns, 'get_future_times', function() {
				return array(
		...
		birch_defn( $ns, 'add_booking_preferences_section', function() use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'render_booking_preferences_section', function() {
				echo "";
			} );

		birch_defn( $ns, 'get_booking_preferences', function() {
				$options = get_option( 'birchschedule_options' );
				return $options['booking_preferences'];
			} );

		birch_defn( $ns, 'get_cut_off_times_html', function() use( $ns, $birchschedule ) {
				global $birchpress;
...
?>
		...
		birch_defn( $ns, 'get_future_times_html', function() use( $ns, $birchschedule ) {
				global $birchpress;
...
?>
		...
		birch_defn( $ns, 'render_booking_policies', function() use( $ns, $birchschedule ) {
				$booking_preferences = $ns->get_booking_preferences();
