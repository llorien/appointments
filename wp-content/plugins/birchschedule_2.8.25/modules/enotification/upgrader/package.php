...
birch_ns( 'birchschedule.enotification.upgrader', function( $ns ) {
        ...
        birch_defn( $ns, 'init', function() use( $ns, $birchschedule ) {
                ...
                birch_defmethod( $birchschedule, 'upgrade_module', 'enotification', $ns->upgrade_module );

            } );

        birch_defn( $ns, 'init_data', function() use( $ns, $birchschedule, $_ns_data ) {
        ...
        birch_defn( $ns, 'get_default_options_notification', function() use( $_ns_data ) {
        ...
        birch_defn( $ns, 'upgrade_options_1_0_to_1_1', function() use( $ns, $_ns_data, $birchschedule ) {
        ...
        birch_defn( $ns, 'upgrade_options_1_1_to_1_2', function() use( $ns, $_ns_data, $birchschedule ) {
                $options = $birchschedule->enotification->get_options();
