...
birch_ns( 'birchschedule.cexport', function( $ns ) {
		...
		birch_defn( $ns, 'ajax_export_clients', function() use( $ns ) {
				$title = "clients";
				$date = new DateTime();
		...
		birch_defn( $ns, 'get_clients_as_csv', function() use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'add_scripts', function( $arg ) use( $ns, $birchschedule ) {
