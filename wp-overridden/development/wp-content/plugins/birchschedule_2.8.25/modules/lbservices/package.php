...
birch_ns( 'birchschedule.lbservices', function( $ns ) {
		...
		birch_defn( $ns, 'pre_save_service', function( $service, $service_orig, $config ) use( $ns ) {
		...
		birch_defn( $ns, 'post_get_service', function( $service ) {
		...
		birch_defn( $ns, 'get_services_locations_map', function( $map ) use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'get_locations_services_map', function( $map ) use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'save_service_data', function( $post ) use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'render_location_checkboxes', function( $locations, $assigned_locations ) {
				foreach ( $locations as $location ) {
		...
		birch_defn( $ns, 'render_service_location', function( $post ) use( $ns, $birchschedule ) {
				$locations = get_posts(
					array(
						'post_type' => 'birs_location',
						'nopaging' => true
