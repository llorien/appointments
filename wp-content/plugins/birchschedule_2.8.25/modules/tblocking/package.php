...
birch_ns( 'birchschedule.tblocking', function( $ns ) {
		...
		birch_defn( $ns, 'get_staff_calculated_schedule_by_location',
			function( $work_schedule, $staff_id, $location_id ) use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'save_staff_data', function( $post ) {
		...
		birch_defn( $ns, 'get_default_new_exception', function() {
				return array(
					'minutes_start' => 720,
					'minutes_end' => 780,
					'weeks' => array(
		...
		birch_defn( $ns, 'ajax_new_staff_schedule_exception', function() use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'render_exception', function( $location_id, $uid, $exception ) use( $ns, $birchschedule ) {
				global $birchpress;
...
?>
		...
		birch_defn( $ns, 'render_exception_block', function( $location_id, $uid, $exception ) use( $ns, $birchschedule ) {
...
?>
		...
		birch_defn( $ns, 'get_schedule_exceptions', function( $staff_id, $location_id ) use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'render_timetable_exceptions', function( $staff_id, $location_id ) use( $ns, $birchschedule ) {
...
?>
		...
		birch_defn( $ns, 'render_days_off', function( $post ) use( $ns, $birchschedule ) {
...
?>
		...
		birch_defn( $ns, 'remove_avaliable_time',
			function( $time_options, $staff_id, $location_id, $service_id, $date ) use( $ns, $birchschedule ) {
