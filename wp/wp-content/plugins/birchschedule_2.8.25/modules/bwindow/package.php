...
birch_ns( 'birchschedule.bwindow', function( $ns ) {
		...
		birch_defn( $ns, 'get_staff_schedule_date_start',
			function( $date_start, $staff_id, $location_id, $schedule_id ) use( $ns, $birchschedule ) {
		...
		birch_defn( $ns, 'get_staff_schedule_date_end',
			function( $date_start, $staff_id, $location_id, $schedule_id ) use( $ns ) {
		...
		birch_defn( $ns, 'get_staff_schedule_exception_date_start',
			function( $date_start, $staff_id, $location_id, $exception_id ) use( $ns ) {
		...
		birch_defn( $ns, 'get_staff_schedule_exception_date_end',
			function( $date_start, $staff_id, $location_id, $exception_id ) use( $ns ) {
		...
		birch_defn( $ns, 'render_period', function( $belong_to, $location_id, $uid, $schedule ) use( $ns ) {
...
?>
		...
		birch_defn( $ns, 'render_schedule_period', function( $location_id, $uid, $schedule ) use( $ns ) {
				$ns->render_period( 'schedules', $location_id, $uid, $schedule );
			} );

		birch_defn( $ns, 'render_schedule_exception_period', function( $location_id, $uid, $exception ) use( $ns ) {
