        ...
        birch_defn( $ns, 'render_field_view_frontend',
            function( $field, $value=false, $errors=false ) use ( $ns, $birchschedule ) {
                ...
                if ( !$login_disabled && $logged_in ) {
                    ...
                    $birchschedule->fbuilder->field->render_field_view_frontend->fns['_root']( $field, $value, $errors );
...
?>
        ...
        birch_defn( $ns, 'get_client_logout_link', function() {
                global $birchpress;
        ...
        birch_defn( $ns, 'render_logged_in_info', function() use( $ns, $birchschedule ) {
                global $birchpress;
...
?>
        ...
        birch_defn( $ns, 'render_client_type', function( $field, $value ) use ( $ns, $birchschedule ) {
...
?>
        ...
        birch_defn( $ns, 'render_field_view_builder', function( $field ) use ( $ns, $birchschedule ) {
?>
