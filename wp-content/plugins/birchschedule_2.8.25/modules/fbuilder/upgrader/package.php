...
birch_ns( 'birchschedule.fbuilder.upgrader', function( $ns ) {
        ...
        birch_defn( $ns, 'init', function() use( $ns, $birchschedule ) {
                $ns->init_data();
                birch_defmethod( $birchschedule, 'upgrade_module', 'fbuilder', $ns->upgrade_module );
            } );
...
?>
        ...
        <?php
                ...
                $_ns_data->default_options_form = $_ns_data->default_options_form_1_7;
            } );

        birch_defn( $ns, 'get_default_options_form', function() use ( $_ns_data ) {
        ...
        birch_defn( $ns, 'upgrade_form_options_1_6_to_1_7', function() use ( $ns, $_ns_data, $birchschedule ) {
                global $birchschedule;
        ...
        birch_defn( $ns, 'upgrade_form_options_1_5_to_1_6', function() use ( $ns, $_ns_data, $birchschedule ) {
                global $birchschedule;
        ...
        birch_defn( $ns, 'upgrade_form_options_1_4_to_1_5', function() use ( $ns, $_ns_data, $birchschedule ) {
                $form_options = $birchschedule->fbuilder->get_form_options();
                $version = $form_options['version'];
                if ( $version !== "1.4" ) {
                    return;
        ...
        birch_defn( $ns, 'upgrade_form_options_1_3_to_1_4', function() use( $ns, $_ns_data, $birchschedule ) {
                $form_options = $birchschedule->fbuilder->get_form_options();
                $version = $form_options['version'];
                if ( $version !== "1.3" ) {
                    return;
        ...
        birch_defn( $ns, 'upgrade_form_options_1_2_to_1_3', function() use ( $ns, $_ns_data, $birchschedule ) {
                $form_options = $birchschedule->fbuilder->get_form_options();
                $version = $form_options['version'];
                if ( $version !== "1.2" ) {
                    return;
        ...
        birch_defn( $ns, 'upgrade_form_options_1_1_to_1_2', function() use ( $ns, $_ns_data, $birchschedule ) {
                $form_options = $birchschedule->fbuilder->get_form_options();
        ...
        birch_defn( $ns, 'upgrade_form_options_1_0_to_1_1', function() use ( $ns, $_ns_data, $birchschedule ) {
                $form_options = $birchschedule->fbuilder->get_form_options();
