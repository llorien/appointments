...
birch_ns( 'birchschedule.cmanager', function( $ns ) {
		...
		birch_defn( $ns, 'render_appointments', function( $post ) use( $ns ) {
...
?>
		...
		birch_defn( $ns, 'get_item_actions', function( $item ) use( $ns ) {
		...
		birch_defn( $ns, 'column_default', function( $wp_list_table, $item, $column_name ) use( $ns ) {
		...
		birch_defn( $ns, 'get_columns', function( $wp_list_table ) use( $ns, $birchschedule ) {
...
?>
		...
		birch_defn( $ns, 'prepare_items', function( $wp_list_table ) use( $ns, $birchschedule ) {
