...
birch_ns( 'birchschedule.ppayment', function( $ns ) {
        ...
        birch_defn( $ns, 'redefine_functions', function() use( $ns, $birchschedule ) {
                ...
                birch_defn( $birchschedule->view->bookingform, 'change_appointment1on1_status', $ns->change_appointment1on1_status );
            } );
        ...
        birch_defn( $ns, 'enqueue_script_bookingform', function() use ( $ns, $birchschedule ) {
        ...
        birch_defn( $ns, 'change_appointment1on1_status', function( $appointment1on1_id ) use( $ns, $birchschedule ) {
        ...
        birch_defn( $ns, 'render_settings_prepayment', function() use( $ns, $birchschedule ) {
...
<?php
        ...
        birch_defn( $ns, 'process_prepayment', function( $appointment1on1_id, $payment ) use( $ns, $birchschedule ) {
                global $birchpress;
        ...
        birch_defn( $ns, 'is_prepayment_enabled', function( $is_enabled, $service_id ) use( $ns, $birchschedule ) {
        ...
        birch_defn( $ns, 'get_confirm_message_template', function() {
                $options = get_option( 'birchschedule_options_payments' );
        ...
        birch_defn( $ns, 'get_prepayment_methods', function() {
                return array();
            } );

        birch_defn( $ns, 'get_prepayment_method_html', function( $method_name, $method, $appointment1on1_id ) {
                ob_start();
?>
        ...
        birch_defn( $ns, 'get_prepayment_methods_html', function( $appointment1on1_id ) use( $ns, $birchschedule ) {
                ob_start();
?>
...
<?php
        ...
        birch_defn( $ns, 'get_place_order_html', function() use( $ns, $birchschedule ) {
                ob_start();
?>
        <div>
        ...
        <script type="text/javascript">
            jQuery(function($){
                birchschedule.ppayment.bookingform.init();
            });
        </script>
<?php
                return ob_get_clean();
        ...
        birch_defn( $ns, 'render_payments_page', function() use( $ns, $birchschedule, $_ns_data ) {
                $screen = $ns->get_screen();
?>
        <style type="text/css">
...
?>
        ...
        birch_defn( $ns, 'get_fixed_booking_fee_html', function( $fixed ) {
                ob_start();
?>
        <input type='text'
        ...
        birch_defn( $ns, 'get_percent_booking_fee_html', function( $percent ) {
                ob_start();
?>
        <input type='text'
...
<?php
        ...
        birch_defn( $ns, 'save_service_data', function( $service ) {
        ...
        birch_defn( $ns, 'render_service_settings_prepayment', function( $post ) use( $ns, $birchschedule ) {
...
?>
        ...
        <div class="panel-wrap birchschedule">
            <table class="form-table prepayment">
                <tr class="form-field">
                    <td colspan="2">
                        <div>
                            <input type="checkbox"
