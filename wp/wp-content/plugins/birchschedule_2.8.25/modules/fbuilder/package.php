...
birch_ns( 'birchschedule.fbuilder', function( $ns ) {
        ...
        birch_defn( $ns, 'init_data', function() use ( $ns, $_ns_data ) {
                ...
                $_ns_data->side_column_id = $ns->get_tab_name() . '_side';
                $_ns_data->fields_column_id = $ns->get_tab_name() . '_fields';
            } );

        birch_defn( $ns, 'init', function() use ( $ns, $birchschedule, $_ns_data ) {
        ...
        birch_defn( $ns, 'redefine_functions', function() use ( $ns, $birchschedule ) {

                birch_defn( $birchschedule->view->bookingform, 'save_client',
                    $ns->save_client );

                birch_defn( $birchschedule->view->bookingform, 'validate_booking_info',
                    $ns->validate_bookingform_info );

                birch_defn( $birchschedule->view->bookingform, 'validate_appointment1on1_info',
                    $ns->validate_appointment1on1_info );

                birch_defn( $birchschedule->view->bookingform, 'get_fields_labels',
                    $ns->get_fields_labels );

                birch_defn( $birchschedule->view->appointments->new, 'validate_client_info',
                    $ns->validate_client_info );

                birch_defn( $birchschedule->view->appointments->new, 'validate_appointment1on1_info',
                    $ns->validate_appointment1on1_info );

                birch_defn( $birchschedule->view->appointments->edit->clientlist->edit, 'validate_client_info',
                    $ns->validate_client_info );

                birch_defn( $birchschedule->view->appointments->edit->clientlist->edit, 'validate_appointment1on1_info',
                    $ns->validate_appointment1on1_info );

                birch_defn( $birchschedule->view->appointments->edit->clientlist->edit, 'get_appointment1on1_info_html',
                    $ns->get_appointment1on1_html );

                birch_defn( $birchschedule->view->appointments->edit->clientlist->edit, 'get_client_info_html',
                    $ns->get_client_details_html );

                birch_defn( $birchschedule->view->clients, 'get_client_details_html',
                    $ns->get_client_details_html );

            } );

        birch_defn( $ns , 'init_tab', function() use ( $ns ) {
        ...
        birch_defn( $ns, 'get_action_names_map', function() use ( $_ns_data ) {
                return $_ns_data->action_names;
            } );

        birch_defn( $ns, 'get_action_name', function( $key ) use ( $ns ) {
                $action_names = $ns->get_action_names_map();
                return $action_names[$key];
            } );

        birch_defn( $ns, 'get_base_url', function() use ( $_ns_data ) {
                return $_ns_data->base_url;
            } );

        birch_defn( $ns, 'get_fields_column_id', function() use ( $_ns_data ) {
                return $_ns_data->fields_column_id;
            } );

        birch_defn( $ns, 'get_side_column_id', function() use ( $_ns_data ) {
                return $_ns_data->side_column_id;
            } );

        birch_defn( $ns, 'get_field_type_text_map', function() use ( $_ns_data ) {
                return $_ns_data->field_type_text_map;
            } );

        birch_defn( $ns, 'get_field_type_text', function( $field_type ) use ( $ns ) {
                $map = $ns->get_field_type_text_map();
                return $map[$field_type];
            } );

        birch_defn( $ns, 'get_base_post_url', function() use ( $_ns_data ) {
                return $_ns_data->base_post_url;
            } );

        birch_defn( $ns, 'is_login_disabled', function() use ( $ns ) {
        ...
        birch_defn( $ns, 'is_register_disabled', function() use ( $ns ) {
                $fields_options = $ns->get_fields_options();
        ...
        birch_defn( $ns, 'get_module_path', function() {
                global $birchschedule;
        ...
        birch_defn( $ns, 'enqueue_scripts_calendar', function() use ( $ns ) {
                global $birchschedule;
        ...
        birch_defn( $ns, 'enqueue_scripts_frontend', function() use ( $ns ) {
                global $birchschedule;
        ...
        birch_defn( $ns, 'get_client_fields', function( $keys ) use ( $ns, $birchschedule ) {
                $result = array();
                $fields_options = $ns->get_fields_options();
        ...
        birch_defn( $ns, 'get_appointment1on1_custom_fields', function( $keys ) use ( $ns, $birchschedule ) {
                $result = array();
                $fields_options = $ns->get_fields_options();
                foreach ( $fields_options as $field_id => $field_options ) {
        ...
        birch_defn( $ns, 'get_fields_labels', function() use ( $ns ) {
                $labels = array();
        ...
        birch_defn( $ns, 'get_field_order', function() use ( $ns ) {
        ...
        birch_defn( $ns, 'get_fields_options', function() use ( $ns ) {
                $options = $ns->get_form_options();
                $fields_options = $options['fields'];
        ...
        birch_defn( $ns, 'get_meta_key_label', function( $meta_label, $meta_key ) use ( $ns ) {
                $fields_options = $ns->get_fields_options();
        ...
        birch_defn( $ns, 'get_thankyou_content', function( $content, $appointment1on1_id ) use ( $ns, $birchschedule ) {
                $appointment1on1 =
...
?>
        ...
        birch_defn( $ns, 'get_return_url', function( $url, $arg ) use( $ns, $birchschedule ) {
                global $birchpress;
        ...
        birch_defn( $ns, 'get_success_message', function( $response, $appointment1on1_id ) use( $ns, $birchschedule ) {
                global $birchpress;
        ...
        birch_defn( $ns, 'get_appointment1on1_html', function( $appointment_id, $client_id ) use( $ns, $birchschedule ) {
                $fields_options = $ns->get_fields_options();
...
?>
        ...
        birch_defn( $ns, 'get_bookingform_fields_html', function( $html ) use( $ns, $birchschedule ) {
                $fields_options = $ns->get_fields_options();
                $field_order = $ns->get_field_order();
...
?>
        ...
        birch_defn( $ns, 'get_client_details_html', function( $client_id, $excludes = array() ) use( $ns, $birchschedule ) {
                $fields_options = $ns->get_fields_options();
                $field_order = $ns->get_field_order();
                ob_start();
?>
...
?>
        ...
        birch_defn( $ns, 'validate_client_info', function() use( $ns, $birchschedule ) {
                $errors = array();
                $fields_options = $ns->get_fields_options();
                foreach ( $fields_options as $field_id => $field_options ) {
                    if ( $field_options['belong_to'] === 'client' ) {
        ...
        birch_defn( $ns, 'validate_appointment1on1_info', function() use( $ns, $birchschedule ) {
                $errors = array();
                $fields_options = $ns->get_fields_options();
                foreach ( $fields_options as $field_id => $field_options ) {
                    if ( $field_options['belong_to'] === 'appointment' ) {
        ...
        birch_defn( $ns, 'validate_bookingform_info', function() use( $ns, $birchschedule ) {
        ...
        birch_defn( $ns, 'get_client_type', function() {
        ...
        birch_defn( $ns, 'handle_field_order', function( $field_name ) {
                $field_name = substr( $field_name, 5 );
                $field_name = substr( $field_name, 0, -4 );
                return $field_name;
            } );

        birch_defn( $ns, 'update_field_order', function( $meta_id, $user_id, $meta_key, $meta_value ) use( $ns ) {
        ...
        birch_defn( $ns, 'get_meta_box_order', function( $result ) use( $ns, $birchschedule ) {
                $form_options = $ns->get_form_options();
        ...
        birch_defn( $ns, 'get_option_country', function( $country = 'US' ) use( $ns ) {
                $form_options = $ns->get_form_options();
                return $form_options['fields']['client_country']['default_value'];
            } );

        birch_defn( $ns, 'get_option_state', function( $state ) use( $ns ) {
                $form_options = $ns->get_form_options();
        ...
        birch_defn( $ns, 'route_request', function() use( $ns ) {
        ...
        birch_defn( $ns, 'delete_field', function() use( $ns, $birchschedule ) {
                if ( isset( $_GET['field'] ) ) {
                    $field_id = $_GET['field'];
                } else {
        ...
        birch_defn( $ns, 'new_field', function() use( $ns, $birchschedule ) {
                if ( isset( $_GET['type'] ) ) {
                    $type = $_GET['type'];
                } else {
                    wp_redirect( $ns->get_base_url() );
        ...
        birch_defn( $ns, 'edit_form', function() use( $ns, $birchschedule ) {
                $screen = $ns->get_screen();
                $ns->enqueue_scripts();
                $ns->init_field_boxes();
                add_meta_box( 'birchschedule_standard_fields', __( 'Add a Field', 'birchschedule' ),
                    array( $ns, 'render_toolbox' ), $screen,
                    $ns->get_side_column_id(), 'default' );
            } );
        ...
        birch_defn( $ns, 'get_form_options', function() use( $ns, $birchschedule ) {
        ...
        birch_defn( $ns, 'update_form_options', function( $form_options ) use( $ns ) {
        ...
        birch_defn( $ns, 'init_field_boxes', function() use( $ns, $birchschedule ) {
                $fields = $ns->get_fields_options();
                foreach ( $fields as $field_id => $field ) {
        ...
        birch_defn( $ns, 'get_page_hook', function() use ( $ns ) {
        ...
        birch_defn( $ns, 'render_page', function() use( $ns, $birchschedule ) {
                $screen = $ns->get_screen();
?>
                        ...
                        <div id="poststuff">
                            <div id="post-body" class="metabox-holder columns-2">
                                <div id="postbox-container-1" class="postbox-container">
                                    <?php do_meta_boxes( $screen,
                    $ns->get_side_column_id(), array() ) ?>
                                </div>
                        ...
                        <script type="text/javascript">
                            ...
                            jQuery(document).ready( function($) {
                                ...
                                if(birchschedule.fb.hasOwnProperty('editing_field_box_id')){
                                    editing_field_box_id = birchschedule.fb.editing_field_box_id;
                                }
...
<?php
        ...
        birch_defn( $ns, 'render_toolbox', function() use( $ns, $birchschedule ) {
                $href = $ns->get_base_url() . '&action=new&type=';
                $action = $ns->get_action_name( 'new_field' );
?>
                <ul>
                    <li>
                        <a class="button" href="<?php echo wp_nonce_url( $href . 'single_line_text', $action ); ?>"><?php _e( 'Single Line Text', 'birchschedule' ); ?></a>
                    </li>
                    <li>
                        <a class="button" href="<?php echo wp_nonce_url( $href . 'paragraph_text', $action ); ?>"><?php _e( 'Paragraph Text', 'birchschedule' ); ?></a>
                    </li>
                    <li>
                        <a class="button" href="<?php echo wp_nonce_url( $href . 'drop_down', $action ); ?>"><?php _e( 'Drop Down', 'birchschedule' ); ?></a>
                    </li>
                    <li>
                        <a class="button" href="<?php echo wp_nonce_url( $href . 'checkboxes', $action ); ?>"><?php _e( 'Checkboxes', 'birchschedule' ); ?></a>
                    </li>
                    <li>
                        <a class="button" href="<?php echo wp_nonce_url( $href . 'radio_buttons', $action ); ?>"><?php _e( 'Radio Buttons', 'birchschedule' ); ?></a>
                    </li>
                </ul>
<?php
            } );

        birch_defn( $ns, 'save_new_client', function() use( $ns, $birchschedule ) {
                $client_config = array(
                    'base_keys' => array(),
        ...
        birch_defn( $ns, 'save_client', function() use( $ns, $birchschedule ) {
                $login_disabled = $ns->is_login_disabled();
                if ( $login_disabled ) {
        ...
        birch_defn( $ns, 'get_bool_option_names', function() {
                return array( 'required' );
            } );

        birch_defn( $ns, 'filter_bool_options', function() use( $ns, $birchschedule ) {
        ...
        birch_defn( $ns, 'save_field_options', function() use( $ns, $birchschedule ) {
