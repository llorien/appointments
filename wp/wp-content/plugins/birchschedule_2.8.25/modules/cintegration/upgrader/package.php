...
birch_ns( 'birchschedule.cintegration.upgrader', function( $ns ) {
        ...
        birch_defn( $ns, 'init', function() use ($ns, $birchschedule) {
                ...
                birch_defmethod( $birchschedule, 'upgrade_module', 'cintegration', $ns->upgrade_module );
        ...
        birch_defn( $ns, 'get_db_version_calendar_integration', function() use( $ns ) {
                return get_option( 'birs_db_version_calendar_integration', '1.0' );
            } );

        birch_defn( $ns, 'upgrade_1_0_to_1_1', function() use( $ns, $birchschedule ) {
                global $birchpress;
        ...
        birch_defn( $ns, 'upgrade_1_1_to_1_2', function() use( $ns, $birchschedule ) {
                $version = $ns->get_db_version_calendar_integration();
                if ( $version !== '1.1' ) {
                    return;
                }
        ...
        birch_defn( $ns, 'upgrade_1_2_to_1_3', function() use( $ns, $birchschedule ) {
                $version = $ns->get_db_version_calendar_integration();
                if ( $version !== '1.2' ) {
                    return;
                }
