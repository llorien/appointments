...
birch_ns( 'birchschedule.ppayment.upgrader', function( $ns ) {
        ...
        birch_defn( $ns, 'init', function() use( $ns, $birchschedule ) {
                ...
                birch_defmethod( $birchschedule, 'upgrade_module', 'ppayment', $ns->upgrade_module );
        ...
        birch_defn( $ns, 'init_db', function() use( $ns ) {
        ...
        birch_defn( $ns, 'get_default_options_payments', function() use( $_ns_data ) {
                return $_ns_data->default_options_payments;
            } );

        birch_defn( $ns, 'get_prepayment_confirm_message', function() {
                ob_start();
?>
<h3>
