...
birch_ns( 'birchschedule.bpreferences.upgrader', function( $ns ) {
        ...
        birch_defn( $ns, 'init_db', function() use ( $ns, $_ns_data ) {
        ...
        birch_defn( $ns, 'upgrade_1_1_to_1_2', function() use( $ns ) {
                $version = $ns->get_db_version_booking_preferences();
                if ( $version !== '1.1' ) {
                    return;
                }
        ...
        birch_defn( $ns, 'get_db_version_booking_preferences', function() use( $ns ) {
                $options = get_option( 'birchschedule_options' );
